function [S] = AddVelocitytime_Godfrey(S)
...
S(1).structure(32).table.Properties.VariableNames(1:4) = {'MaleControl','MaleFasted','FemaleControl','FemaleFasted'};
...
S(3).structure(19).table.Properties.VariableNames(1:4) = {'MaleControl','MaleFasted','FemaleControl','FemaleFasted'};
end