function [S] = AddVelDif_Godfrey(S)
...
S(3).structure(20).table.Properties.VariableNames(1:4) = {'MaleControl','MaleFasted','FemaleControl','FemaleFasted'};
...
S(3).structure(21).table.Properties.VariableNames(1:4) = {'MaleControl','MaleFasted','FemaleControl','FemaleFasted'};
...
S(3).structure(22).table.Properties.VariableNames(1:4) = {'MaleControl','MaleFasted','FemaleControl','FemaleFasted'};
end