function [S] = AddRelativePercent_2way_Godfrey(S)
...
S(1).structure(29).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
...
S(1).structure(30).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
...
S(1).structure(31).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
...
S(3).structure(16).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
...
S(3).structure(17).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
...
S(3).structure(18).table.Properties.VariableNames(1:4) = {'MaleControl','FemaleControl','MaleFasted','FemaleFasted'};
end